...
function lengthOfAString(name: string):number{
    const numberOfCharacters:number = name.length;
...
function convertingToUpperAndLowerCase(name: string){
...
function replacingTextInString(message: string):string{
    console.log("Befor Replace:", message);
    const msgReplace = message.replace(/Javascript/g,"TypeScript");
