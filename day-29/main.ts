...
function findingThePositionOfSubstring(message: string): number{
...
function  checkingForTextPresence(message: string): boolean{
...
function extractingSubstring(message: string){
